export default {
  ...
  'detailed-object': {
    ...
    // Comments
    comments_title: 'Izoh',
    comments_type_label: 'Izoh turi',
    comments_text_label: 'Izoh matni',
    comments_add: 'Izoh qo\'shish',
    comments_sending: 'Yuborilmoqda...',
    comments_empty: 'Hozircha izohlar yo\'q',
    comments_empty_hint: '',
    comments_load_error: 'Izohlarni yuklab bo\'lmadi',
    comments_send_error: 'Izoh yuborib bo\'lmadi',
    comments_text_required: 'Izoh matnini kiriting',
    comments_other_placeholder: 'O\'z izohingizni kiriting',
    comments_unknown_type: 'Izoh',
    comments_unknown_user: 'Foydalanuvchi',
    comments_no_image: 'Izohlar mavjud emas (Hisoblanmagan)',

    comment_type_1: 'Chegaradan chiqqan hudud yondosh konga tegishli',
    comment_type_2: 'Topoharitaga aniqlik kiritish (noto\'g\'ri — boshqa kon, yoki noto\'g\'ri balandliklar)',
    comment_type_3: 'PDFda hajm bor, qazish ishlari olib borilmagan',
    comment_type_4: 'Boshqa — izohni o\'zingiz yozing',
